...
public class EasyTextAddUtils {
    ...
    public static void addBill(PDDocument document, int pageIndex, boolean needBill, PDType0Font font ) throws IOException {
        addTextIfNeeded(document, pageIndex, needBill, "需要發票", 200,font);
    }

    public static void addTaxId(PDDocument document, int pageIndex, boolean needTaxId, PDType0Font font ) throws IOException {
        addTextIfNeeded(document, pageIndex, needTaxId, "需要統一編號", 250,font);
    }
    public static void addBoth(PDDocument document, int pageIndex, boolean needTaxId, PDType0Font font ) throws IOException {
        addTextIfNeeded(document, pageIndex, needTaxId, "需要發票 + 收據", 250,font);
    }
}
